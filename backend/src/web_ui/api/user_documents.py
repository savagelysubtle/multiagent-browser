...
async def get_supported_formats():
    ...
    return {
        ...
        "import_formats": [
            ...
            {"format": "docx", "name": "Word Document", "description": "Microsoft Word documents"},
            {"format": "pdf", "name": "PDF", "description": "PDF documents (text extraction)"},
