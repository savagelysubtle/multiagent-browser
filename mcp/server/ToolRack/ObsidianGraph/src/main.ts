...
`;
  ...
  // Add information about tool naming convention for users
  console.error("\nIMPORTANT: Tool Names Use Underscores");
  console.error("The following tools are available with underscore naming convention:");
  console.error("- list_available_vaults");
  console.error("- create_note");
  console.error("- read_note");
  console.error("- edit_note");
  console.error("- search_vault");
  console.error("- move_note");
  console.error("- create_directory");
  console.error("- delete_note");
  console.error("- add_tags");
  console.error("- remove_tags");
  console.error("- rename_tag");
  console.error("");
  console.error("Prompts also use underscore naming:");
  console.error("- list_vaults");
  console.error(""); // Empty line for readability
  ...
  try {
    ...
    for (const tool of tools) {
      try {
        ...
        console.error(`[Error] Error registering tool ${tool.name}:`, error);
        throw error;
      }
    }
